...
// Handler para crear usuarios. POST para agregar el usuario y GET para obtener el formulario
...
// Handler para mostrar la lista de usuarios creados
...
// Handler para editar un usuario existente. GET para obtener el formulario y POST para modificarlo
